...
基本的な使い方に慣れたら、以下の高度な機能を活用してさらに効率化しましょう。

### 7. [サブエージェントガイド](./docs/07-subagents-guide.md)

複雑なタスクを専門エージェントに委任する方法を学びます。

**内容:**
- サブエージェントとは
- サブエージェントの種類（Explore、Plan、General-Purpose）
- サブエージェントの使い方
- 実践的な活用例
- ベストプラクティス

👉 **大規模なコードベースを扱う方へ!** 探索や計画立案を効率的に行いましょう。

---

### 8. [Hooksガイド](./docs/08-hooks-guide.md)

特定のイベント時に自動実行されるスクリプト（フック）の活用方法を学びます。

**内容:**
- Hooksとは
- Hooksの種類（SessionStart、PromptSubmit、BeforeToolCall、AfterToolCall）
- Hooksの設定方法
- 実践的な活用例（環境チェック、自動Lint、ファイル保護など）
- ベストプラクティス

👉 **作業を自動化したい方へ!** イベント駆動で開発フローを効率化しましょう。

---

### 9. [Slash Commandsガイド](./docs/09-slash-commands-guide.md)

カスタムコマンドを作成して、よく使うタスクを素早く実行する方法を学びます。

**内容:**
- Slash Commandsとは
- 組み込みコマンド
- カスタムコマンドの作成方法
- 実践的なカスタムコマンド例（テスト実行、コードレビュー、デプロイなど）
- ベストプラクティス

👉 **定型作業を効率化したい方へ!** カスタムコマンドで作業をスピードアップしましょう。

---

### 10. [MCPガイド](./docs/10-mcp-guide.md)

Model Context Protocol（MCP）を使って、外部サービスと連携する方法を学びます。

**内容:**
- MCPとは
- MCPでできること
- MCPサーバーの設定方法
- よく使うMCPサーバー（GitHub、Slack、PostgreSQL、Google Driveなど）
- 実践的な活用例
- ベストプラクティス

👉 **外部サービスと連携したい方へ!** GitHub、Slack、データベースなどとシームレスに統合しましょう。

---

### 11. [.claudeignoreガイド](./docs/11-claudeignore-guide.md)

Claude Codeに読み込ませたくないファイルを除外する設定方法を学びます。
...
👉 **パフォーマンスとコストを最適化したい方へ!** 不要なファイルを除外して効率化しましょう。
...
6. **[Slash Commandsガイド](./docs/09-slash-commands-guide.md)** でカスタムコマンドを作成

### 🔵 応用編（必要に応じて）

7. **[サブエージェントガイド](./docs/07-subagents-guide.md)** で大規模コードベースを効率的に扱う
8. **[Hooksガイド](./docs/08-hooks-guide.md)** でイベント駆動の自動化を実現
9. **[MCPガイド](./docs/10-mcp-guide.md)** で外部サービスと連携
10. **[.claudeignoreガイド](./docs/11-claudeignore-guide.md)** でパフォーマンスを最適化
